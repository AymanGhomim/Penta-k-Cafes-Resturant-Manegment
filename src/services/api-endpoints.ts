export const API_ENDPOINTS = {
  ...
  cafe: {
    ...
    loyaltySettings: "/cafe/loyalty/settings",
    loyaltyTransactions: "/cafe/loyalty/transactions",
    expenses: "/cafe/expenses",
    cashRegister: "/cafe/cash-register",
    cashSummary: "/cafe/cash-register/summary",
