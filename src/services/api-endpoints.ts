export const API_ENDPOINTS = {
  ...
  platform: { tenants: "/platform/tenants", dashboard: "/platform/dashboard", plans: "/platform/plans", activityLogs: "/platform/activity-logs", users: "/platform/users", roles: "/platform/roles" },
  cafe: {
